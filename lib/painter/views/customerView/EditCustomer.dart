...
class _EditCustomerState extends State<EditCustomer> {
  ...
  void createRecord() async {
    if (_key.currentState.validate()) {
      ...
      await databaseReference.collection("painter").document(id).collection(
          "customerList").document(customerId).updateData({
        "user_id": id,
...
setState(() {
  customerId=widget.doc['customerId'].toString();
  fullnameController.text= widget.doc['fullname'].toString();
  emailContoller.text=widget.doc['email'].toString();
  contactController.text=widget.doc['contact'].toString();
  addressController.text=widget.doc['address'].toString();
  cityController.text=widget.doc['city'].toString();
  stateController.text=widget.doc['state'].toString();
  pincodeController.text=widget.doc['pincode'].toString();
  _radioValueCustomer=widget.doc['customerType'];
  _radioValueCustomerStatus=widget.doc['customerStatus'];
});
